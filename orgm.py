...
def main(argv):
    ...
    # CLI Actions
    parser.add_option("-ad", "--add", help="Add an Item. Can include any Element args.")
    parser.add_option("-ae", "--add_empty", help="Add an empty Item to the end of the data file")
    parser.add_option("-rm", "--remove", help="Remove an Item. Can include --regex flag arg to match by regex. Must include one Element arg to match on.")
    ...
    parser.add_option("-sg", "--show_grouped", help="Display all items grouped by distinct values for the Element type provided. e.g. - grouped by Title.")
    parser.add_option("-se", "--show_elements", help="Display all element values for the Element type provided. e.g. - all Projects.")
    parser.add_option("-rb", "--rebuild_grouped", help="Rebuild the data file grouped by distinct values for the Element type provided. e.g. - grouped by Title.")
    parser.add_option("-bk", "--backup", help="Backup data file. Takes mandatory additonal argument --filename [My_Filename.txt]")
